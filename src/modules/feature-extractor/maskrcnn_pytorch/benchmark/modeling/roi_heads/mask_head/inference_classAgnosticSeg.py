...
class MaskPostProcessor(nn.Module):
    ...
    def __init__(self, masker=None, class_agnostic_seg=False):
    ...
    def forward(self, x, boxes):
        ...
        if self.class_agnostic_seg:
            mask_prob = mask_prob[index, 1][:, None]
        else:
...
def make_roi_mask_post_processor(cfg):
    if cfg.MODEL.ROI_MASK_HEAD.POSTPROCESS_MASKS:
        ...
        masker = None
    mask_post_processor = MaskPostProcessor(masker, cfg.MODEL.CLS_AGNOSTIC_SEGM)
