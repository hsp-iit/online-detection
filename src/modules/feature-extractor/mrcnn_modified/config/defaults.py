...
_C.MODEL.CLS_AGNOSTIC_SEGM = False
...
# ---------------------------------------------------------------------------- #
# Minibootstrap parameters
# ---------------------------------------------------------------------------- #
_C.MINIBOOTSTRAP = CN()
_C.MINIBOOTSTRAP.RPN = CN()
_C.MINIBOOTSTRAP.RPN.BATCH_SIZE = 2000
_C.MINIBOOTSTRAP.RPN.ITERATIONS = 2
_C.MINIBOOTSTRAP.RPN.NUM_CLASSES = 15
# IoU thresholds to choose RPN's positives and negatives
_C.MINIBOOTSTRAP.RPN.NEG_IOU_THRESH = 0.3
_C.MINIBOOTSTRAP.RPN.POS_IOU_THRESH = 0.7
_C.MINIBOOTSTRAP.RPN.SHUFFLE_NEGATIVES = True

_C.MINIBOOTSTRAP.DETECTOR = CN()
_C.MINIBOOTSTRAP.DETECTOR.BATCH_SIZE = 2000
_C.MINIBOOTSTRAP.DETECTOR.ITERATIONS = 2
...
_C.MINIBOOTSTRAP.DETECTOR.SHUFFLE_NEGATIVES = True
