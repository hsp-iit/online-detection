...
class DatasetCatalog(object):
    DATA_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), os.path.pardir, os.path.pardir, os.path.pardir, os.path.pardir, os.path.pardir, 'Data', 'datasets'))
    DATASETS = {
        "coco_2017_train": {
