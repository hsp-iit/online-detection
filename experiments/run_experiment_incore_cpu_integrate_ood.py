...
if args.load_detector_models:
    ...
    feature_extractor.falkon_detector_models = model
    feature_extractor.regressors_detector_models = models
    feature_extractor.stats_detector = stats
...
torch.save(refined_predictions, os.path.join(output_dir, 'refined_boxes'))
"""
"""
refined_predictions = torch.load(os.path.join(output_dir, 'refined_boxes'))
"""
# Initialize feature extractor
