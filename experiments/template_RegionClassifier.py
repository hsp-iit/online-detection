...
# experiment_name = 'new'
cfg_path = '/home/elisa/Repos/python-online-detection/experiments/Configs/config_region_classifier.yaml'
...
# opts['sigma'] = 25
# opts['M'] = 1000
# opts['imset_train'] = '/home/elisa/Data/Datasets/iCubWorld-Transformations/ImageSets/test_TASK2_30objs_manual.txt'
...
# torch.save(predictions, 'predictions_all')
